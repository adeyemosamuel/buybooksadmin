...
const TableWrapper = () => {
    ...
    return <CustomTable columns={columns} ajaxUrl={`${getAllOrdersWithCustomParamsFilter}?orderStatus=APPROVED`} dataName="orders" />;
}

export default class ViewAll extends Component {
  render() {
    return(
        <AppLayout pageName="View All Approved Orders">
